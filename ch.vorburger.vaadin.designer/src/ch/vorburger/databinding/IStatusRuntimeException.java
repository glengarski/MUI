...
/**
 * Runtime Exception wrapping an IStatus.
 * 
 * Used by {@link ExceptionThrowingILogger}.
 * 
...
public class IStatusRuntimeException extends RuntimeException {
	...
	public IStatusRuntimeException(IStatus status) {
	...
	public String toString() {
		return CLASS_NAME + ": " + status.toString();
	}
